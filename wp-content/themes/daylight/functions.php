...
function insert_fb_in_head() {
	...
	if (is_front_page()) {
		$title = 'Shravan Kumar Kasagoni - Web Developer & Designer';
	} else {
    ...
    echo '<meta name="twitter:creator" content="@techieshravan">' . "\n";
    echo '<meta name="twitter:site" content="@techieshravan">' . "\n";
    echo '<meta name="twitter:domain" content="Shravan Kumar Kasagoni">' . "\n";
    echo '<meta property="og:site_name" content="Shravan Kumar Kasagoni">' . "\n";
    ...
    if (!has_post_thumbnail( $post->ID )) { 
    		echo '<meta property="og:image" content="http://theshravan.net/wp-content/uploads/face-300x300.jpg"/>' . "\n";
	}
	else{
...
function create_post_work() {
	register_post_type('work', // Register Custom Post Type
		array(
		'labels' => array(
			'name' => __('Work', 'daylight'), // Rename these to suit
		),
		'public' => true,
...
function create_post_publications() {
	register_post_type('publications', // Register Custom Post Type
		array(
		'labels' => array(
			'name' => __('Publications', 'daylight'), // Rename these to suit
		),
		'public' => true,
		'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
		'has_archive' => false,
