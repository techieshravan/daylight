console.log('Hello, fellow developer!' +
	...
	'\nhttps://techieshravan.github.io/primitive' +
	'\n\nNew Moon is world\'s best theme for coding. ' +
	'\nhttps://techieshravan.github.io/new-moon' +
	'\n\nP.S. Try typing ↑ ↑ ↓ ↓ ← → ← → B A');
...
function nightMode() {
	if (localStorage.getItem('stylesheet')) {
		...
		localStorage.setItem('stylesheet', '/wp-content/themes/daylight/css/night.css');
...
var easter_egg = new Konami(function () {
	...
	link.type = 'text/css'
	link.rel = 'stylesheet'
	link.href = '/wp-content/themes/daylight/css/.css?ver=5'
