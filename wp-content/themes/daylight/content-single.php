...
<!--      <input type="email" name="email" required id="newsletter-email" class="email" placeholder="Email address"-->
...
<!--    <div class="author">-->
<!--      <h2>Note</h2>-->
<!--      <p>I'm Shravan. If you enjoy my content, please consider supporting what I do.</p>-->
<!--      <a class="button yellow-button" href="https://ko-fi.com/techieshravan" target="_blank">Support my work <i class="fas fa-coffee"></i></a>-->
<!--    </div>-->
